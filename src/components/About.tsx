        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          <div className={`lg:col-span-3 ${visible ? "animate-slide-from-left" : "opacity-0"}`}>
            ...
            <p className="mt-7 text-muted-foreground leading-relaxed text-[15px]">
              At MechAir Dynamics, we don't just sell air compressors—we provide the lifeblood of your industrial operations. Led by Ashish Kumar and Ankit Kalshania, our mission is to deliver high-performance compressed air solutions that minimize downtime and maximize efficiency.
            </p>
